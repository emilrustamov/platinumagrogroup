...
export const productDetail = {
  ...
  universalDescription: 'З Platinum AgroGroup набыць {productNameLower} з Турцыі стала вельмі проста. Platinum AgroGroup як кампанія-пастаўшчык арганічнай садавіны і гародніны можа экспартаваць патрэбную вам колькасць у любую кропку свету. Будучы адной з лепшых кампаній харчовай дыстрыбуцыі ў Турцыі, наша кампанія пастаўляе вам толькі найсвяжэйшую садавіну і гародніну. Уся наша {productNamePlural}, свежая яна ці сушаная, вырошчваецца турэцкімі фермерамі з належнай увагай. Мы гатовыя і поўныя рашучасці забяспечыць вас найлепшай турэцкай {productNamePlural}. Як Platinum AgroGroup, турэцкі экспарцёр аптовай свежай садавіны і гародніны, наша місія — прадставіць свету харчаванне, якое мы любім і старанна вырошчваем.'
}
