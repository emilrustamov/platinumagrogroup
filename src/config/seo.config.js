...
export const SITE_NAME = 'Платинум Агро Групп'
...
export const defaultSeo = {
  title: 'Платинум Агро Групп — Wholesale Fresh Fruits & Vegetables Exporter Worldwide',
  description: 'Платинум Агро Групп is a worldwide exporter of premium wholesale fresh fruits and vegetables, delivering top-quality produce globally with reliable logistics.',
...
export const pagesSeo = {
  ...
  about: {
    title: 'About Us — Платинум Агро Групп',
    description: 'Learn about Платинум Агро Групп, a foreign trade supply brand with nearly 10 years of experience in food and agricultural products export.',
    path: '/about',
    keywords: 'about us, agro company, fruit exporter, vegetable exporter, worldwide trade, agriculture business'
  },
  contact: {
    title: 'Contact Us — Платинум Агро Групп',
    description: 'Get in touch with Платинум Агро Групп for wholesale fruit and vegetable inquiries, pricing, and export logistics.',
    path: '/contact',
    keywords: 'contact, fruit supplier contact, vegetable supplier contact, wholesale inquiry, export inquiry'
  },
  fruits: {
    title: 'Fruits — Wholesale Fresh Fruit Export | Платинум Агро Групп',
  ...
  vegetables: {
    title: 'Vegetables — Wholesale Fresh Vegetable Export | Платинум Агро Групп',
